...
import com.efeiyi.ec.model.Image;
import com.efeiyi.ec.model.MyUser;
import com.efeiyi.ec.model.Panel;
import com.efeiyi.ec.model.Product;
import com.efeiyi.ec.model.ProductFavorite;
import com.efeiyi.ec.model.ProductModel;
import com.efeiyi.ec.model.ProductPicture;
import com.efeiyi.ec.model.Project;
...
public class ProductController {
    ...
    public boolean addProductFavorite(HttpServletRequest request) throws Exception {
        MyUser currentUser = AuthorizationUtil.getMyUser(request);
        Boolean flag = true;
        if (currentUser.getId() != null) {
            ...
            xSaveOrUpdate.getParamMap().put("user_id", AuthorizationUtil.getMyUser(request).getId());
