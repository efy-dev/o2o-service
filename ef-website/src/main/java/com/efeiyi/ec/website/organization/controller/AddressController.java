...
public class AddressController extends BaseController {
    ...
    @ResponseBody
    public JSONObject getDefaultConsumerAddress(HttpServletRequest request) {
        ConsumerAddress consumerAddress;
        try {
            consumerAddress = addressManager.getConsumerAddressByStatus(AuthorizationUtil.getMyUser(request).getId(), "2");
    ...
    public Map getConsumerAddressList(HttpServletRequest request) {
        ...
        List<ConsumerAddress> consumerAddressList;
         ...
         String userId = AuthorizationUtil.getMyUser(request).getId();
    ...
    public Map addConsumerAddress(HttpServletRequest request) {
        ...
        MyUser user = AuthorizationUtil.getMyUser(request);
